module ActiveAdmin
  class Resource
    module Naming
      ...
      def resource_name_alias
        @resource_name_alias ||= @options[:alias]
        @resource_name_alias ||= singular_human_name
        @resource_name_alias ||= resource_class.name.gsub('::',' ')

      end

      def plural_resource_name_alias
        @plural_resource_name_alias ||= @options[:alias].pluralize if @options[:alias]
        @plural_resource_name_alias ||= plural_human_name
        @plural_resource_name_alias ||= resource_name_alias.pluralize
      end
